...
func NewGRPCServer(usecase usecase.Storage, host string, port string) *GRPCServer {
	return &GRPCServer{
...
func (g *GRPCServer) StartGRPCServer() error {
	...
	pb.RegisterStorageServiceServer(g.server, &StorageService{service: g.usecase})
