...
type AuthServiceClient interface {
	...
	Auth(ctx context.Context, in *Token, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *authServiceClient) Auth(ctx context.Context, in *Token, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
...
type AuthServiceServer interface {
	...
	Auth(context.Context, *Token) (*Empty, error)
...
func (UnimplementedAuthServiceServer) Auth(context.Context, *Token) (*Empty, error) {
