...
const (
	...
	AuthService_Auth_FullMethodName     = "/user.AuthService/Auth"
)
...
const (
	APIKeyService_CreateAPIKey_FullMethodName = "/user.APIKeyService/CreateAPIKey"
	APIKeyService_DeleteAPIKey_FullMethodName = "/user.APIKeyService/DeleteAPIKey"
	APIKeyService_GetAPIKeys_FullMethodName   = "/user.APIKeyService/GetAPIKeys"
	APIKeyService_CheckAPIKey_FullMethodName  = "/user.APIKeyService/CheckAPIKey"
)
...
var APIKeyService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "user.APIKeyService",
...
const (
	CollectionService_GetCollection_FullMethodName = "/user.CollectionService/GetCollection"
)
